            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto py-0">
                        <a href="/home_client/${US.id}" class="nav-item nav-link active">Home</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Pages <i
                                    class="fa fa-angle-down mt-1"></i></a>
                            <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                <a href="/cart/${US.id}" class="dropdown-item">Shopping Cart</a>
                        ...
                        <td class="align-middle">
                            <div class="input-group quantity mx-auto" style="width: 100px;">
                                <div class="input-group-btn">
                                    <a href="/cart/${US.id}/giamSoLuong/${c.idSP}" class="btn btn-sm btn-primary btn-minus">
                                ...
                                <input type="text"
                                       ...
                                       value="${DSSP[c.idSP]}">
                                <div class="input-group-btn">
                                    <a href="/cart/${US.id}/tangSoLuong/${c.idSP}" class="btn btn-sm btn-primary btn-plus">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </div>
                            </div>
                        </td>
                        <td class="align-middle">${c.giaban*DSSP[c.idSP]}</td>
                        <td class="align-middle">
                            <a href="/cart/${US.id}/xoaProduct/${c.idSP}" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a>
                        </td>
                    </tr>
                </c:forEach>
            ...
            <div class="bg-light p-30 mb-5">
                ...
                <div class="pt-2">
                    <div class="d-flex justify-content-between mt-2">
                        <h5>Total</h5>
                        <h5>${tongTien + 0} VND</h5>
                    </div>
                    <form action="/hoa-don/addHD/${US.id}" method="post">
            ...
            <div class="row">
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        <a class="text-secondary mb-2" href="/client"><i class="fa fa-angle-right mr-2"></i>Home</a>
