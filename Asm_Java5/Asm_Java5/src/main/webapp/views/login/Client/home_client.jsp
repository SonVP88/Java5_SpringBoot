            ...
            <div class="d-inline-flex align-items-center">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="/edit-khachhang/${US.id}" class="dropdown-item" type="button">Edit</a>
    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-4">
            <div class="product-offer mb-30" style="height: 200px;">
                <img class="img-fluid" src="../../../resources/img/8.png" alt="">
            ...
            <div class="product-offer mb-30" style="height: 200px;">
                <img class="img-fluid" src="../../../resources/img/10.png" alt="">
                <div class="offer-text">
                    <h6 class="text-white text-uppercase">Save 20%</h6>
                    <h3 class="text-white mb-3">Special Offer</h3>
                    <a href="" class="btn btn-primary">Shop Now</a>
...
<%--    ListTaiNghe start--%>
<div>
<%--    <form action="/ASM/tai-nghe/search">--%>
<%--        <div class="input-group">--%>
    ...
    <table class="table table-bordered">
        ...
        <c:forEach items="${page.getContent()}" var="sp">
            <tr>
                ...
                <td>${sp.mota}</td>
                <td>
                    <a href="/cart/${US.id}/add-tai-nghe/${sp.idSP}" class="btn btn-primary">Add to Cart</a>
                    <a href="/product/detail_product_client/${sp.idSP}" class="btn btn-primary">Detail</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
